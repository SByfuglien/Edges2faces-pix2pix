...
class Edges2facesModel(BaseModel):
	...
	def modify_commandline_options(parser, is_train=True):
		...
		Returns:
			the modified parser.
		"""
		parser.set_defaults(norm='batch', netG='unet_256', dataset_mode='edges2faces', no_flip=True, batch_size=64)  # You can rewrite default values for this model. For example, this model usually uses aligned dataset as its dataset.
		if is_train:
